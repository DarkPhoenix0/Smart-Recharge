      ...
      <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
          ...
          >
            ...
            <div
              class="mt-2 text-slate-400 dark:text-slate-400 xl:hidden text-center"
            >
            ...
            <div class="mt-8">
              ...
              <a
                href=""
                class="text-slate-500 block mt-2 text-xs sm:text-sm"
            ...
            <div
              class="flex items-center text-slate-600 dark:text-slate-500 mt-4 text-xs sm:text-sm"
            >
              <input
                id="remember-me"
                type="checkbox"
