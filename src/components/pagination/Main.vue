<template>
  <ul class="pagination mt-3">
    <li class="pagination-item">
      <a href="#" @click.prevent="onClickFirstPage" :class="isInFirstPage? 'disabled':''" :disabled="isInFirstPage">Première</a>
    </li>
    <li class="pagination-item">
    ...
    <li class="pagination-item">
      <a href="#" @click.prevent="onClickLastPage" :class="isInLastPage? 'disabled':''" :disabled="isInLastPage">Dernière</a>
    </li>
  </ul>
</template>
